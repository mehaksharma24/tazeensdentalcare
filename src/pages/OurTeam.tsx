...
function TazeenSection() {
  ...
  // Replace with your own images in /assets/images/about/
  const tazeenImages = [
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 items-center">
        ...
        <motion.div initial={{ opacity: 0, x: 30 }} animate={isVisible ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.6, delay: 0.2 }}>
          ...
          <div className="mt-4 space-y-3 text-neutral-600 text-sm leading-relaxed">
            <p>The founder, Tazeen, is a Registered Dental Hygienist and the driving force behind Tazeen Dental Care. 
              She built the clinic on a simple guiding belief: comfort is part of the cure. With a strong clinical background 
              and daily hands-on experience as a hygienist, she understands how important trust and consistency are in patient care. 
              She personally helps shape and oversee clinical protocols to ensure every cleaning and treatment is 
              thorough, gentle, and educational.</p>
            <p>Her vision for the clinic is a welcoming, energetic space designed for patients of all ages, including children 
              and families. The practice is built to feel approachable and stress-free, with a strong focus on comfort, 
              communication, and quality care—values that align closely with Dr. Nazia’s patient-centered approach. Together, 
              this creates a team environment where patients receive consistent, compassionate care from their first visit onward.</p>
          </div>
    ...
    <section ref={ref} className="section-padding bg-gradient-to-br from-brand-green/5 via-white to-brand-teal/5">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 items-center">
        <motion.div initial={{ opacity: 0, x: -30 }} animate={isVisible ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.6 }} className="order-2 lg:order-1">
          ...
          <div className="mt-4 space-y-3 text-neutral-600 text-sm leading-relaxed">
            <p>Dr. Nazia Mian is a dentist who earned her Doctor of Dental Surgery (DDS) from the Schulich School of Medicine & Dentistry 
              at Western University in 2023, following earlier training in Bachelor of Dental Surgery. 
              She has been working as an associate dentist since August 2023 in Mississauga and Milton, 
              where she serves a diverse patient population and continues to focus on staying current with advances in dentistry.</p>
             <br></br>
            <p>Her practice emphasizes patient comfort, clear communication, and gentle, detail-oriented care, with a strong focus on 
              ensuring patients understand their treatment options and feel at ease. She is fluent in multiple languages 
              including English, Pashto, Urdu, Hindi, and Punjabi. Outside of work, she enjoys traveling, hiking, and spending time with 
              family, and she practices at Tazeen Dental Care, where patients describe her as caring, patient, and highly professional.</p>
          </div>
          <div className="mt-5 flex flex-wrap gap-2">
