...
export const servicesList = [
  ...
  },
  {
    ...
    points: [
      ...
      'Removal of bacteria and plaque buildup',
  ...
  },
  {
    ...
    desc: 'Root canal treatment helps save an infected or badly damaged tooth while relieving pain and restoring function.',
    points: [
    ...
    image:
      'https://images.pexels.com/photos/6812568/pexels-photo-6812568.jpeg?auto=compress&cs=tinysrgb&w=1200',
  },
  {
    id: 'teeth-whitening',
...
function HeroBanner() {
  return (
    <section
      ...
      style={{
        background:
          'linear-gradient(135deg, rgba(232,168,56,0.1) 0%, rgba(0,165,181,0.08) 50%, rgba(107,191,74,0.1) 100%)',
      }}
    >
      <FloatingTooth
      ...
      <div className="relative max-w-7xl mx-auto px-4 text-center">
        ...
        >
          <h1 className="font-heading text-4xl md:text-5xl font-bold text-neutral-900">
            Dental Services in{' '}
            <span className="text-brand-teal">Milton</span>
          </h1>

          <p className="mt-3 text-neutral-600 max-w-lg mx-auto">
            Preventive, Restorative & Emergency Care — keeping your teeth
      ...
      <div className="relative max-w-6xl mx-auto space-y-6">
        {servicesList.map((service, i) => (
          <motion.div
            ...
            className={`group bg-white rounded-2xl border border-neutral-100 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden scroll-mt-24 p-3 ${
              service.badge ? 'ring-2 ring-brand-teal/20' : ''
            }`}
          >
            <div className="grid md:grid-cols-5 gap-4 md:gap-6 items-center">

              {/* FIXED IMAGE SIZE FOR ALL SERVICES */}
              <div
                className={`md:col-span-2 relative h-52 md:h-[260px] rounded-xl overflow-hidden ${
                  i % 2 === 1 ? 'md:order-2' : ''
                }`}
              >
                <img
                ...
                {service.badge && (
                  <span className="absolute top-3 left-3 text-[10px] font-bold text-white bg-brand-teal/90 backdrop-blur-sm px-2.5 py-1 rounded-full">
                    {service.badge}
                  </span>
                )}
              </div>
              ...
              {/* SERVICE CONTENT */}
              <div
                className={`md:col-span-3 p-4 md:py-6 md:pr-5 ${
                  i % 2 === 1 ? 'md:order-1 md:pl-5' : ''
                }`}
              >
                ...
                <p className="mt-1.5 text-neutral-600 text-lg">
                  {service.desc}
                </p>
                ...
                <ul className="mt-4 grid sm:grid-cols-2 gap-2.5">
                  {service.points.map((point) => (
                    <li
                      key={point}
                      className="flex items-start gap-2.5 text-lg text-neutral-700"
                    >
                ...
                {service.link && (
                  <Link
                    to={service.link}
                    className="inline-flex items-center gap-1.5 mt-4 text-lg font-semibold text-brand-teal hover:text-brand-teal-dark transition-colors"
                  >
                    Learn more
...
function CTASection() {
  return (
    <section className="py-12 px-4">
      <div
        className="max-w-4xl mx-auto rounded-[2rem] p-8 md:p-10 text-center text-white relative overflow-hidden"
        style={{
          background:
            'linear-gradient(135deg, #00A5B5 0%, #008A97 50%, #4A9E2F 100%)',
        }}
      >
        <FloatingSparkle
        ...
        <div className="relative">
          ...
          <p className="mt-2 text-white/80 text-lg">
            Book a comprehensive exam and let our team create a plan for your
            unique needs.
          </p>
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-3">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full border-2 border-white/30 text-white hover:bg-white/10 transition-all font-medium text-lg"
            >
              Call 905-999-8144
            </a>
          </div>
